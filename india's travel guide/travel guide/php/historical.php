...
<body>
  ...
  <header class="img-fluid">
    <nav>
      ...
      <div class="menu">
        ...
        <a href="contact.htm" class="middle">Contact us</a>
      </div>
    </nav>
    <main>
      <section>
  ...
  <div class="row  jumbotron">
    ...
    $query = "SELECT `id`, `name`, `image`, `info` ,`type` FROM `places` WHERE `type`='historical'";
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 bg-light">
          ...
          <div class="card">
            ...
            <div class="card-body bg-dark text-white">
              ...
              <p class="container "><?php echo $place['info']; ?></p>
