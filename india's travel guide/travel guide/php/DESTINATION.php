...
<body>
  ...
  <div class="row jumbotron" >
    ...
    $query = "SELECT `id`, `name`, `image`, `info` ,`type` FROM `places` WHERE 1";
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
            ...
            <div class="card" >
              ...
              <div class="card-body bg-dark text-white">
                ...
                <img src="../places/<?php echo $product['image']; ?>" id="img1"  alt="image" style="height: 300px;width:400px" class="img-fluid">
                </a>
                <center>
                  <h6 class="card-title  bg-info p-2 text-white" id="h6"> <?php echo $product['name']; ?></h6>
                </center>
                <p class="container"  style="height: 140px" id="p1";><?php echo $product['info']; ?></p>
...
<div class="container-fluid text-center text-md-left">
  ...
  <div class="row">
    ...
    <div class="col-md-6 mt-md-0 mt-3">
      ...
      <!-- Content -->
      <h5 class="text-uppercase text-light">Mera Bharat</h5>
