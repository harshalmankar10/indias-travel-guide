...
<body>
    ...
    <header>
        <nav>
            ...
            <div class="menu">
                ...
                <div class="dropdown">
                    <button style="font-weight:bold;" class="dropbtn ">DESTINATION</button>
    ...
    <div class="row  p-3 m-3 bg-dark">
        ...
        $query = "SELECT `id`, `image`, `name` FROM `gallery`  order by Rand() limit 9";
        ...
        ?>
                ...
                <div class="col-md-4  ">
                    <div class="thumbnail">
                        <a href="../places/<?php echo $place['image']; ?>" target="_blank">
                            <img class="img1 img-thumbnail" src="../places/<?php echo $place['image']; ?>" alt="Lights" style="width:500px;height:350px;border:3px solid yellow">
                            <div class="caption">
                                <p style="color: white;font-size:30px;text-align:center"><?php echo $place['name']; ?></p>
                            </div>
                        </a>
                    </div>
                </div>
...
<!-- Footer -->
<footer class="page-footer font-small bg-light  pt-4" style="background:linear-gradient( orange 25%, white 50%, green 75%);">
